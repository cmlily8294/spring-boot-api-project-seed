...
public class CodeGenerator {
    ...
    private static final String JDBC_URL = "jdbc:postgresql://148.70.0.138:5432/gistest";
    ...
    private static final String AUTHOR = "caolong";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

    //表名
    private static final String TABLE_NAME = "student";
    // postgreSql 对应序列
    private static final String SEQ_NAME = "public.student_id_seq";
